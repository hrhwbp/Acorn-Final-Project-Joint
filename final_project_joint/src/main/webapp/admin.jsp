...
<script type="text/javascript" src="resources/admin/js/dash-charts.js"></script>
    ...
    <div class="container">
      ...
      <!-- SERVER UPTIME -->
			<div class="half-unit">
	      		...
	      		<hr>
	      		<div class="cont">
					<p><img src="resources/admin/images/up.png" alt=""> <bold>Up</bold> | 356ms.</p>
				</div>
			</div>
      		...
      		<div class="framemail">
    			<div class="window">
			        <ul class="mail">
			            ...
			            <li>
			                <i class="read"></i>
			                <img class="avatar" src="resources/admin/images/photo02.jpg" alt="avatar">
			            ...
			            <li>
			                <i class="read"></i>
			                <img class="avatar" src="resources/admin/images/photo03.jpg" alt="avatar">
			            ...
			            <li>
			                <i class="read"></i>
			                <img class="avatar" src="resources/admin/images/photo04.jpg" alt="avatar">
        ...
        <div class="col-sm-3 col-lg-3">
      		<div class="dash-unit">
	            ...
	            <div class="flexslider">
					<ul class="slides">
						<li><img src="resources/admin/images/slide01.png" alt="slider"></li>
						<li><img src="resources/admin/images/slide02.png" alt="slider"></li>
					</ul>
            </div>
				<div class="cont">
	  ...
	  <!-- LIVE VISITORS BLOCK -->     
      		<div class="half-unit">
	      		...
	      		<div class="cont">
      			<p><bold>388</bold></p>
      			<p><img src="resources/admin/images/up-small.png" alt=""> 412 Max. | <img src="resources/admin/images/down-small.png" alt=""> 89 Min.</p>
	      		</div>
      		</div>
	  ...
	  <!-- PAGE VIEWS BLOCK -->     
      		<div class="half-unit">
      			...
      			<p><img src="resources/admin/images/up-small.png" alt=""> 23.88%</p>
	      		</div>
      		</div>
      	</div>
			...
			<div class="col-sm-3 col-lg-3">
 	  		...
 	  		<!-- LAST USER BLOCK -->     
				<div class="half-unit">
	      		...
	      		<hr>
	      			<div class="cont2">
	      				<img src="resources/admin/images/user-avatar.jpg" alt="">
	      				<br>
	      				<br>
	      				<p>Paul Smith</p>
